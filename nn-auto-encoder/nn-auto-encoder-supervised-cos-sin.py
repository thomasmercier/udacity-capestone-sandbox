...
for i in range(300):
    ...
    b = h_pool1_norm.eval(feed_dict={img: batch, cos_sin_theta:cos_sin_theta_})
    c = h_concat1_norm.eval(feed_dict={img: batch, cos_sin_theta:cos_sin_theta_})
    d = h_concat2_norm.eval(feed_dict={img: batch, cos_sin_theta:cos_sin_theta_})
